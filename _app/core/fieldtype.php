...
abstract class Fieldtype extends Addon
{
    ...
    public function render_instructions_above()
    {
        ...
        if (is_array($this->field_config['instructions'])) {
            if (isset($this->field_config['instructions']['above'])) {
                ...
                return "<small class='above'>{$this->field_config['instructions']['above']}</small>";
            }
            ...
            return "<small class='above'>{$this->field_config['instructions']}</small>";
        }
    }
    ...
    public function render_instructions_below()
    {
        ...
        return "<small class='below'>{$this->field_config['instructions']['below']}</small>";
    }
    ...
    {
        return $this->render_label() . $this->render_instructions_above() . $this->render() . $this->render_instructions_below();
    }
     ...
     * @return string
     */
    public static function render_fieldtype($fieldtype, $fieldname, $field_config, $field_data, $tabindex = NULL, $input_key = '[yaml]', $field_id = NULL)
    {
        $output = '';
